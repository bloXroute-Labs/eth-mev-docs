...
- **`coinbaseBefore`/`After`**: builder’s balance before/after block. The relay should also check the real value of the block by looking at all transaction fees and income to the coinbase address.
